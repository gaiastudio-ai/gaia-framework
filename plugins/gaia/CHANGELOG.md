...
- route meeting paths through the shared helper, and fix the release guidance (#1833)
...
- (init,retro) address adversarial-review findings on the 2 defect fixes
- (retro) cross-retro-detect scans the canonical retrospective/ subdir
- (init) coerce scalar ci_platform to object form in generate-config.sh
...
- implement the orchestrator-driven Mode B teammate turn loop (#1663)

## [1.206.1] — 2026-06-23

### Fixed

- (meeting) make Mode B dispatch mandatory under team mode (#1660)

## [1.206.0] — 2026-06-22

### Added

- (meeting) dispatch persistent teammates under Mode B (#1657)
