...
lead routes this skill through Mode B, the market-research subagent (gaia:analyst) runs as a
...
- **Spawn seam.** `research_spawn_subagent "gaia:analyst" "gaia-market-research"` runs the
