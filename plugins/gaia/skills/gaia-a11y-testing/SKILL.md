...
lead routes this skill through Mode B, the accessibility-testing subagent (gaia:manual-tester) runs as a
...
- **Spawn seam.** `research_spawn_subagent "gaia:manual-tester" "gaia-a11y-testing"` runs the
