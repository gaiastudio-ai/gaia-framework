...
#   2. Run validate-gate.sh for prereqs (none beyond resolve-config for this skill)
...
SCRIPT_NAME="gaia-review-mobile/setup.sh"
WORKFLOW_NAME="review-mobile"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-review-mobile/scripts/setup.sh → ../../../scripts
