...
export FORCE_DESIGN_ENTRY_POINT="gaia-create-epics"
export FORCE_DESIGN_SPRINT_ID="<sprint-id from $ARGUMENTS, or empty>"
bash "${CLAUDE_PLUGIN_ROOT}/skills/gaia-create-epics/scripts/setup.sh" --force-design --reason "$FORCE_DESIGN_REASON" --entry-point "$FORCE_DESIGN_ENTRY_POINT" ${FORCE_DESIGN_SPRINT_ID:+--sprint-id "$FORCE_DESIGN_SPRINT_ID"}
```
