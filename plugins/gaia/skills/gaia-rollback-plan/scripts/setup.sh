#!/usr/bin/env bash
# setup.sh — gaia-rollback-plan skill setup
#
...
[ -x "$VALIDATE_GATE" ] || die "validate-gate.sh not found or not executable at $VALIDATE_GATE — validate-gate.sh must be installed first"
