...
lead routes this skill through Mode B, the mobile-testing subagent (gaia:mobile-dev) runs as a
...
- **Spawn seam.** `research_spawn_subagent "gaia:mobile-dev" "gaia-mobile-testing"` runs the
