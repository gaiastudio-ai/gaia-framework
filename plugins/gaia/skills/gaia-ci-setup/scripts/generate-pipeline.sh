#!/usr/bin/env bash
# generate-pipeline.sh — AF-2026-05-31-3 / Test14 F-11
#
...
cat > "$_tmp" <<EOF
# Generated by /gaia-ci-setup (AF-2026-05-31-3 / Test14 F-11 generator).
...
# the file still carries the init-stub marker (the prior \`exit 1\` stub
...
# on regeneration per FR-RSV2-38).
name: gaia-pre-merge
on:
  pull_request:
