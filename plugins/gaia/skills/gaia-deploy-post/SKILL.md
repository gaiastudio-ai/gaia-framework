---
name: gaia-deploy-post
description: Post-deployment health and metric validation with structured pass/fail report. Use when "post-deploy verify" or /gaia-deploy-post.
version: 1.0.0
agent: any
triggers:
  - post-deploy verify
...
!${CLAUDE_PLUGIN_ROOT}/skills/gaia-deploy-post/scripts/setup.sh
...
This skill follows the canonical skill pattern established by the code-review and deploy-checklist skills.
...
!${CLAUDE_PLUGIN_ROOT}/skills/gaia-deploy-post/scripts/finalize.sh
