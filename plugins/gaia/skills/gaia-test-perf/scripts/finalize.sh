#!/usr/bin/env bash
# finalize.sh — gaia-test-perf skill lifecycle finalize (E73-S2).
#
# Standard lifecycle hook (parallel to gaia-test-e2e/finalize.sh):
...
SCRIPT_NAME="gaia-test-perf/finalize.sh"
