...
lead routes this skill through Mode B, the innovation subagent (gaia:innovation-strategist) runs as a
...
- **Spawn seam.** `research_spawn_subagent "gaia:innovation-strategist" "gaia-innovation"` runs the
