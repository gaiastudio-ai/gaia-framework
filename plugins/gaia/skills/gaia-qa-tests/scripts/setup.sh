#!/usr/bin/env bash
# setup.sh — gaia-qa-tests skill setup
#
# Mechanical extension of the canonical reference implementation in
# gaia-code-review/scripts/setup.sh. Only WORKFLOW_NAME and SCRIPT_NAME
