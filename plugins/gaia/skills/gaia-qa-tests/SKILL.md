...
| `bash-dev`            | `**/*.bats` + `test/**/*.bats`                                                        | (none)                                |
| `embedded-dev`        | `test/**/*_test.{c,cpp}` + `**/*_test.{c,cpp}`                                       | `gcov` / `lcov` (optional)            |
