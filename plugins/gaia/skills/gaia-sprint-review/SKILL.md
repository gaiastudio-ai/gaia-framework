...
- Rubric input: `${CLAUDE_PLUGIN_ROOT}/rubrics/base/sprint-review.json` (the AI-2026-05-16-1 deliverable). Val reads the rubric and applies its 14 severity rules across 3 dimensions (story-to-goal traceability, velocity-vs-capacity fit, PRD priority coverage) to produce per-goal PASSED/FAILED/PARTIAL verdicts.
