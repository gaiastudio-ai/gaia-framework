#!/usr/bin/env bash
# finalize.sh — planning skill finalize for gaia-edit-prd
#
# Modelled on the gaia-brainstorm/scripts/finalize.sh reference implementation.
# Only WORKFLOW_NAME and SCRIPT_NAME differ — the body is otherwise identical.
#
# Responsibilities:
