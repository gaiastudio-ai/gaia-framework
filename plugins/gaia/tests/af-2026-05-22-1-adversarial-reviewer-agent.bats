...
@test "persona Memory section invokes memory-loader.sh with ground-truth scope" {
...
@test "persona declares the envelope output contract" {
...
@test "persona has Review Lenses section covering PRD/Architecture/UX/Test-plan" {
...
@test "gaia-create-prd Step 13 dispatches adversarial-reviewer by name" {
...
@test "gaia-edit-prd dispatches adversarial-reviewer by name" {
...
@test "gaia-create-arch dispatches adversarial-reviewer by name" {
  grep -qF '**`adversarial-reviewer`**' "$PLUGIN_ROOT/skills/gaia-create-arch/SKILL.md"
}

@test "gaia-edit-arch dispatches adversarial-reviewer by name" {
...
@test "gaia-edit-ux dispatches adversarial-reviewer by name" {
...
@test "gaia-brownfield Phase 8b dispatches adversarial-reviewer by name" {
...
@test "no skill dispatches the buggy non-existent 'gaia-adversarial-review' or 'adversarial-review' agent name" {
