...
@test "dead-reference-scan.sh is CLEAN after tech-debt-review retirement" {
...
@test "tech-debt-review SKILL.md is a deprecation redirect" {
...
@test "tech-debt-review standalone scripts are removed" {
...
@test "gaia-help.csv has triage-findings, not tech-debt-review" {
...
@test "workflow-manifest.csv drops the tech-debt-review row" {
...
@test "lifecycle-sequence.yaml drops the tech-debt-review node" {
