...
@test "TC-RSV2-OVERLAY-01: gaia-review-qa -> vera" {
...
@test "TC-RSV2-OVERLAY-02: gaia-review-test -> sable" {
...
@test "TC-RSV2-OVERLAY-03: gaia-test-automate -> sable" {
...
@test "TC-RSV2-OVERLAY-04: gaia-review-security -> zara" {
...
@test "TC-RSV2-OVERLAY-05: gaia-review-perf -> juno" {
...
@test "TC-RSV2-OVERLAY-06: gaia-review-mobile -> talia" {
...
@test "TC-RSV2-OVERLAY-07: gaia-validate-design-a11y -> christy" {
...
@test "TC-RSV2-OVERLAY-08: gaia-test-e2e -> sable" {
  run "$SCRIPT" --skill gaia-test-e2e
  [ "$status" -eq 0 ]
  assert_json_field "$output" "agent_id" "sable"
}

@test "TC-RSV2-OVERLAY-09: gaia-test-perf -> sable" {
  run "$SCRIPT" --skill gaia-test-perf
  [ "$status" -eq 0 ]
  assert_json_field "$output" "agent_id" "sable"
}

@test "TC-RSV2-OVERLAY-10: gaia-test-dast -> sable" {
  run "$SCRIPT" --skill gaia-test-dast
  [ "$status" -eq 0 ]
  assert_json_field "$output" "agent_id" "sable"
}

@test "TC-RSV2-OVERLAY-11: gaia-test-a11y -> sable" {
  run "$SCRIPT" --skill gaia-test-a11y
  [ "$status" -eq 0 ]
  assert_json_field "$output" "agent_id" "sable"
}

@test "TC-RSV2-OVERLAY-12: gaia-test-mobile-e2e -> talia" {
  run "$SCRIPT" --skill gaia-test-mobile-e2e
  [ "$status" -eq 0 ]
  assert_json_field "$output" "agent_id" "talia"
}

@test "TC-RSV2-OVERLAY-13: gaia-test-device-matrix -> talia" {
  run "$SCRIPT" --skill gaia-test-device-matrix
  [ "$status" -eq 0 ]
  assert_json_field "$output" "agent_id" "talia"
}

@test "TC-RSV2-OVERLAY-14: gaia-deploy -> soren" {
...
@test "TC-RSV2-OVERLAY-STACK-01: gaia-review-code --stack ts-dev" {
...
@test "TC-RSV2-OVERLAY-STACK-02: gaia-review-code --stack java-dev" {
...
@test "TC-RSV2-OVERLAY-STACK-03: gaia-review-code --stack python-dev" {
...
@test "TC-RSV2-OVERLAY-STACK-04: gaia-review-code --stack go-dev" {
...
@test "TC-RSV2-OVERLAY-STACK-05: gaia-review-code --stack flutter-dev" {
...
@test "TC-RSV2-OVERLAY-STACK-06: gaia-review-code --stack mobile-dev" {
...
@test "TC-RSV2-OVERLAY-STACK-07: gaia-review-code --stack angular-dev" {
...
@test "TC-RSV2-OVERLAY-ERR-01: unknown skill -> exit 1 + stderr diagnostic" {
