...
setup() {
  ...
  SKILL="$REPO_ROOT/gaia-framework/plugins/gaia/skills/gaia-sprint-plan/SKILL.md"
  SCRIPTS_DIR="$REPO_ROOT/gaia-framework/plugins/gaia/skills/gaia-sprint-plan/scripts"
}
