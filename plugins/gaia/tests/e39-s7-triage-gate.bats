...
@test "triage-sentinel check fails when triage has not run" {
...
@test "triage-sentinel check passes after triage writes the sentinel" {
...
@test "triage-sentinel rejects an unsafe sprint-id" {
...
@test "sprint-close SKILL.md documents the mandatory triage gate" {
...
@test "triage SKILL.md documents its sprint-close prerequisite role" {
