#!/usr/bin/env bats
# evidence-judgment-parity.bats — per-skill parity bats for gaia-review-security
# (E75-S2, FR-RSV2-46, ADR-075).
#
# Tier 1: evidence — semgrep + gitleaks scan output
# Tier 2: judgment — security findings with severities
...
SKILL_NAME='gaia-review-security'
