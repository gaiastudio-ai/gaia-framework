#!/usr/bin/env bats
# evidence-judgment-parity.bats — per-skill parity bats for gaia-review-deps
# (E75-S2, FR-RSV2-46, ADR-075).
#
# Tier 1: evidence — npm-audit + license-checker scan output
# Tier 2: judgment — dependency findings with severities + package field
