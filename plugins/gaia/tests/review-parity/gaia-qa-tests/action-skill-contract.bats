#!/usr/bin/env bats
# action-skill-contract.bats — per-skill action-skill contract for gaia-qa-tests
# (E75-S2, FR-RSV2-46, FR-RSV2-47, ADR-075, ADR-077).
#
# Tier 1: evidence — QA test-case generation outcome flags
# Tier 2: judgment — QA findings (placeholders, mocks_sut, breaks_suite)
