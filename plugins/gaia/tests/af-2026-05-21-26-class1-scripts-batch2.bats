...
@test "infer-parent-epic.sh EPICS_FILE canonical-first" {
...
@test "skill-proposal.sh tech-debt-dashboard canonical-first" {
...
@test "load-spec.sh SPEC_PATH canonical-first" {
  grep -qF '.gaia/artifacts/implementation-artifacts/quick-spec-' "$PLUGIN_ROOT/skills/gaia-quick-dev/scripts/load-spec.sh"
}

@test "validate-canonical-filename.sh resolve_impl_dir recognizes canonical .gaia/" {
