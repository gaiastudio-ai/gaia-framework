...
setup() {
  ...
  PRD_SKILL="$REPO_ROOT/gaia-framework/plugins/gaia/skills/gaia-create-prd/SKILL.md"
  ARCH_SKILL="$REPO_ROOT/gaia-framework/plugins/gaia/skills/gaia-create-arch/SKILL.md"
}
