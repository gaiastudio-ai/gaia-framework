...
setup() {
  ...
  SKILL="$REPO_ROOT/gaia-framework/plugins/gaia/skills/gaia-sprint-review/SKILL.md"
  SCRIPTS_DIR="$REPO_ROOT/gaia-framework/plugins/gaia/skills/gaia-sprint-review/scripts"
}
